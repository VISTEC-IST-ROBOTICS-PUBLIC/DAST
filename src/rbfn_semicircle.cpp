...
bool rbfn_semicircle::initializeCenters(){
    ...
    // Use same center
    rbfn_centers_file.open(file_directory+"rbfn_semicircle_files/rbfn_centers.txt", ios::in); // ------------> Joe 5/2/2026
    // rbfn_centers_file.open(file_directory+"gian_rbfn_files/gian_net_8/rbfn_centers_gian.txt", ios::in);  // -----------------> Gian

    // Use Nine version
    // rbfn_centers_file.open(file_directory+"NineRL_Weight_txt/agent_0_RBF_centers.txt", ios::in); 
...
bool rbfn_semicircle::initializeWeights(){
    ...
    // version 1
    string filename = file_directory+"rbfn_semicircle_files/1_rbfn_weights_"+to_string(id)+".txt"; // < --------------- Joe 5/2/2026

    // string filename = file_directory+"gian_rbfn_files/gian_net_8/rbfn_weights_gian_"+to_string(id)+".txt"; // ----------------------> Gian
    
    // test version
    // string filename = file_directory+"rbfn_semicircle_files/rbfn_weights_0.txt"; 

    // // Version Nine
    // string filename = file_directory+"NineRL_Weight_txt/agent_"+to_string(id)+"_RBF_weight"+".txt"; 
